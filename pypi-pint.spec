...
Source0  : https://files.pythonhosted.org/packages/20/bb/52b15ddf7b7706ed591134a895dbf6e41c8348171fb635e655e0a4bbb0ea/pint-0.24.4.tar.gz
...
%prep
%setup -q -n pint-0.24.4
cd %{_builddir}/pint-0.24.4
pushd ..
cp -a pint-0.24.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731005682
